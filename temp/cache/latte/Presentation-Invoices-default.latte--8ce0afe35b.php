...
';
					if ($invoice->status != 'paid') /* line 172 */ {
						echo '                                            <li>
                                                <a href="';
						echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('markAsPaid!', [$invoice->id, '_csrf_token' => $csrfToken])) /* line 175 */;
...
';
						...
						echo '                                            <li>
                                                <a href="';
						echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('markAsCreated!', [$invoice->id, '_csrf_token' => $csrfToken])) /* line 182 */;
...
';
					...
					if ($isUserAdmin) /* line 188 */ {
						echo '                                            <li>
                                                <a href="';
						echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('delete', [$invoice->id, '_csrf_token' => $csrfToken])) /* line 191 */;
