...
';
			if (isset($isUserAdmin) && $isUserAdmin && !$isSuperAdmin) /* line 100 */ {
				...
				echo '" class="dropdown-item">
							...
							<li>
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Security:sqlAudit')) /* line 124 */;
				echo '" class="dropdown-item">
							...
							<li>
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Security:dashboard')) /* line 129 */;
				echo '" class="dropdown-item">
					...
					<li class="nav-item">
						<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('ModuleAdmin:default')) /* line 138 */;
				echo '" class="nav-link">
...
';
			...
			echo '					
';
			if ($isSuperAdmin) /* line 145 */ {
				echo '					<li class="nav-item">
						<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(':Settings:default')) /* line 147 */;
				echo '" class="nav-link">
							<i class="bi bi-gear"></i><span class="nav-text">Nastavení</span>
						</a>
					</li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="securitySuperDropdown">
							<li>
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Security:default')) /* line 159 */;
				echo '" class="dropdown-item">
									<i class="bi bi-house-door me-2"></i>Přehled nástrojů
								</a>
							</li>
							<li>
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Security:sqlAudit')) /* line 164 */;
				echo '" class="dropdown-item">
									<i class="bi bi-search me-2"></i>SQL Security Audit
								</a>
							</li>
							<li>
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Security:dashboard')) /* line 169 */;
				echo '" class="dropdown-item">
									<i class="bi bi-speedometer2 me-2"></i>Security Dashboard
								</a>
							</li>
							...
							<li>
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Security:rateLimitStats')) /* line 175 */;
				echo '" class="dropdown-item">
									<i class="bi bi-bar-chart me-2"></i>Rate Limit Stats
								</a>
							</li>
						</ul>
					</li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="moduleAdminDropdown">
							<li>
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('ModuleAdmin:default')) /* line 189 */;
				echo '" class="dropdown-item">
							...
							<li>
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('ModuleAdmin:users')) /* line 194 */;
				echo '" class="dropdown-item">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="superAdminDropdown">
							<li>
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Users:rateLimitStats')) /* line 208 */;
				echo '" class="dropdown-item">
								...
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Tenants:default')) /* line 213 */;
				echo '" class="dropdown-item">
							...
							<li>
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Users:default')) /* line 219 */;
				echo '" class="dropdown-item">
							...
							<li>
								<a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Tenants:add')) /* line 226 */;
				echo '" class="dropdown-item">
				...
				<ul class="navbar-nav">
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							';
			if (isset($currentUser) && $currentUser) /* line 240 */ {
				echo LR\Filters::escapeHtmlText($currentUser->username) /* line 240 */;
			} else /* line 240 */ {
				echo 'Uživatel';
			}
			echo "\n";
			if (isset($currentUserRole)) /* line 241 */ {
				if ($isSuperAdmin) /* line 242 */ {
					echo '								<span class="badge ms-1" style="background-color: #B1D235; color: #212529; font-weight: 600;">Super Admin</span>
';
				} elseif ($currentUserRole === 'admin') /* line 244 */ {
					echo '								<span class="badge bg-danger ms-1">Admin</span>
';
				} elseif ($currentUserRole === 'accountant') /* line 246 */ {
...
';
			...
			echo '					</span>
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(':Users:profile')) /* line 255 */;
			echo '" class="dropdown-item">
								<i class="bi bi-person"></i> Můj profil
							</a></li>
							<li><hr class="dropdown-divider"></li>
							<li><a href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(':Sign:out')) /* line 259 */;
			echo '" class="dropdown-item">
...
';
	...
	<div class="container">
';
		foreach ($flashes as $flash) /* line 271 */ {
			echo '		<div class="alert alert-';
			echo LR\Filters::escapeHtmlAttr($flash->type) /* line 271 */;
			echo '">
';
			if ($flash->type === 'success') /* line 272 */ {
				echo '			<i class="bi bi-check-circle-fill me-2"></i>';
			}
			echo "\n";
			if ($flash->type === 'info') /* line 273 */ {
				echo '			<i class="bi bi-info-circle-fill me-2"></i>';
			}
			echo "\n";
			if ($flash->type === 'warning') /* line 274 */ {
				echo '			<i class="bi bi-exclamation-triangle-fill me-2"></i>';
			}
			echo "\n";
			if ($flash->type === 'danger') /* line 275 */ {
				echo '			<i class="bi bi-x-circle-fill me-2"></i>';
			}
			echo '
			';
			echo LR\Filters::escapeHtmlText($flash->message) /* line 276 */;
			echo '
		</div>
';
		...
		echo "\n";
		$this->renderBlock('content', [], 'html') /* line 279 */;
		echo '	</div>

';
		if (isset($userLoggedIn) && $userLoggedIn) /* line 282 */ {
			echo '	<footer class="mt-5 py-4 text-center">
		<div class="container">
			<p class="mb-0">
				QRdoklad (verze 1.9.4) &copy; ';
			echo LR\Filters::escapeHtmlText(date('Y')) /* line 286 */;
...
';
	...
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 294 */;
		echo '/js/invoice-form.js"></script>
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 295 */;
		echo '/js/settings.js"></script>
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 296 */;
		echo '/js/tables.js"></script>
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 297 */;
		echo '/js/search.js"></script>
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 298 */;
	...
	<script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 300 */;
	...
	public function prepare(): array
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === 'extends') {
			foreach (array_intersect_key(['moduleKey' => '56', 'moduleData' => '56', 'menuKey' => '66', 'menuItem' => '66', 'flash' => '271'], $this->params) as $ʟ_v => $ʟ_l) {
