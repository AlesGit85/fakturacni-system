...
final class Template_e0e3e0f478 extends Latte\Runtime\Template
{
...
';
			if ($isUserAccountant) /* line 189 */ {
				echo '            <a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('add')) /* line 190 */;
