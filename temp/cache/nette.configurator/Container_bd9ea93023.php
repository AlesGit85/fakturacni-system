...
class Container_bd9ea93023 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Presentation\Api\ApiPresenter' => [2 => ['application.1']],
		'App\Presentation\Dodavatel\DodavatelPresenter' => [2 => ['application.2']],
		...
		'App\Presentation\Faktura\FakturaPresenter' => [2 => ['application.5']],
		'App\Presentation\Home\HomePresenter' => [2 => ['application.6']],
		'App\Presentation\Odberatel\OdberatelPresenter' => [2 => ['application.7']],
	...
	public function createServiceApplication__1(): App\Presentation\Api\ApiPresenter
	{
		$service = new App\Presentation\Api\ApiPresenter;
	...
	public function createServiceApplication__2(): App\Presentation\Dodavatel\DodavatelPresenter
	{
		$service = new App\Presentation\Dodavatel\DodavatelPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__5(): App\Presentation\Faktura\FakturaPresenter
	{
		$service = new App\Presentation\Faktura\FakturaPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__7(): App\Presentation\Odberatel\OdberatelPresenter
	{
		$service = new App\Presentation\Odberatel\OdberatelPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
